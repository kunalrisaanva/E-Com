  ...
  return ( 
    <div className='flex-col'>
      ...
      <div className='absolute left-[27.34%] right-[60.25%] top-[7.15%] bottom-[71.32%] w-[156.2px] h-[137.56px]'>
        <h1 className='font-[Raleway] font-[400]  leading-[47px] text-5xl lowercase text-[#FFFFFF] '> Get in touch</h1>
      </div>
      <div className='flex-col absolute left-[ 29.44%] right-[ 61.96%] top-[38.99%] bottom-[65.9%] flex-wrap '>
        <h1 className='font-[Raleway] font-[400]  leading-[16px] text-xl  lowercase text-[#FFFFFF] items-end mt-7'>contact@e-comm.ng</h1>
        <h1 className='font-[Raleway] font-[400]  leading-[16px] text-xl  lowercase text-[#FFFFFF] items-end mt-8 ml-2 '>+234 4556 6665 34 </h1>
        <h1 className='font-[Raleway] font-[400]  leading-[16px] text-xl  lowercase text-[#FFFFFF] items-end mt-8 ml-2 '>20 Prince Hakerem Lekki
        Phase 1, Lagos. </h1>
