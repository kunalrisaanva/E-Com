      ...
      <div className="flex px-[102px]">
        <div className=" ">
          <div className=" bg-[#F6F7F8] h-[371px] w-[270px] mt-[49px]">
            ...
            {/* <div className="px-[20px] text-[18px] text-[#262626]">
                <div className="flex items-center justify-between pt-[25px]">
                  <span>Nike</span>
                  <span className="text-[#22262A]">2</span>
                </div>
                <div className="flex items-center justify-between pt-[20px]">
                  <span className="text-[#33A0FF]">Airmax</span>
                  <span className="text-[#33A0FF]">21</span>
                </div>
                <div className="flex items-center justify-between pt-[20px]">
                  <span>Nike</span>
                  <span>2</span>
          ...
          <div className="h-[144px] w-[270px] bg-[#F6F7F8] mt-[30px]">
            <h4 className="text-[18px] text-[#22262A] font-medium pt-[19px] pl-[20px]">Prices</h4>
            <div>
          ...
          <div className="h-[123px] w-[270px] bg-[#F6F7F8] mt-[30px]">
            <h3 className="text-[18px] text-[#22262A] font-medium pt-[19px] pl-[20px]"> COLOR</h3>
          ...
          {/* <div className="h-[245px] w-[270px] bg-[#F6F7F8] mt-[30px]">
            <h4 className="text-[#22262A] text-[18px] font-medium pl-[20px] pt-[19px]">Brand</h4>
            ...
            <div className="flex justify-between pt-[20x]">
                <span>Nike</span>
                <span>99</span>
            </div>
